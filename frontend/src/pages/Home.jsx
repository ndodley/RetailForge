    ...
    return (
        <div style={{
            ...
            <section style={{ marginTop: 4, display: 'flex', gap: 24, flexWrap: 'wrap', justifyContent: 'center', boxShadow: 'none', border: 'none' }}>
                <div style={{ background: 'var(--surface-2)', borderRadius: 16, boxShadow: 'var(--shadow-1)', padding: 32, minWidth: 220, maxWidth: 320, textAlign: 'center', border: '1px solid var(--border)' }}>
                    <span style={{ fontSize: 40, color: 'var(--link)', display: 'block', marginBottom: 12 }}>🚚</span>
                    <h3 style={{ fontWeight: 700, fontSize: 20, marginBottom: 8 }}>Fast Delivery</h3>
                    <p style={{ color: 'var(--muted-2)', fontSize: 16 }}>Get your products delivered quickly and reliably to your doorstep.</p>
                </div>
                <div style={{ background: 'var(--surface-2)', borderRadius: 16, boxShadow: 'var(--shadow-1)', padding: 32, minWidth: 220, maxWidth: 320, textAlign: 'center', border: '1px solid var(--border)' }}>
                    ...
                    <p style={{ color: 'var(--muted-2)', fontSize: 16 }}>Shop with confidence using our secure and trusted payment options.</p>
                </div>
                <div style={{ background: 'var(--surface-2)', borderRadius: 16, boxShadow: 'var(--shadow-1)', padding: 32, minWidth: 220, maxWidth: 320, textAlign: 'center', border: '1px solid var(--border)' }}>
                    ...
                    <p style={{ color: 'var(--muted-2)', fontSize: 16 }}>Browse our curated selection of best-selling and highly rated items.</p>
                </div>
            </section>
            <section style={{
                ...
                <h2 style={{ textAlign: 'center', fontWeight: 800, fontSize: 32, color: 'var(--text)', marginBottom: 32, letterSpacing: 1 }}>Featured Categories</h2>
                <div style={{ display: 'flex', justifyContent: 'center', gap: 40, flexWrap: 'wrap' }}>
                    <div style={{ background: 'var(--surface-2)', borderRadius: 14, boxShadow: 'var(--shadow-1)', padding: 28, minWidth: 180, textAlign: 'center', border: '1px solid var(--border)' }}>
                        <span style={{ fontSize: 32, color: 'var(--link)', display: 'block', marginBottom: 10 }}>🎮</span>
                        <div style={{ fontWeight: 600, fontSize: 18, marginBottom: 4 }}>Games & Consoles</div>
                        <div style={{ color: 'var(--muted-2)', fontSize: 15 }}>Latest releases and classics</div>
                    </div>
                    <div style={{ background: 'var(--surface-2)', borderRadius: 14, boxShadow: 'var(--shadow-1)', padding: 28, minWidth: 180, textAlign: 'center', border: '1px solid var(--border)' }}>
                        ...
                        <div style={{ color: 'var(--muted-2)', fontSize: 15 }}>Gadgets, computers, and more</div>
                    </div>
                    <div style={{ background: 'var(--surface-2)', borderRadius: 14, boxShadow: 'var(--shadow-1)', padding: 28, minWidth: 180, textAlign: 'center', border: '1px solid var(--border)' }}>
                        ...
                        <div style={{ color: 'var(--muted-2)', fontSize: 15 }}>Trendy styles for everyone</div>
                    </div>
                </div>
            </section>
        </div>
